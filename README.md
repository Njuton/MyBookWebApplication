...
**Стэк технологий:** Java 8, Spring Core, Spring MVC, JPA/Hibernate, HyperSQL, MS SQL Server, Apache Tomcat, JSTL, JSP, Apache Tiles, Apache Ant, Apache Maven, HTML, CSS.
