...
insert into "Order" (address, zip_code, date_and_time, status, city_id, client_id)
	VALUES ('площадь Захарова, д.34, кв.1', 299002, TIMESTAMP '2017-12-01 10:30:00', 'SHIPPED', 1, 1);
...
insert into "Order" (address, zip_code, date_and_time, status, city_id, client_id)
	VALUES ('Общежитие № 2 ВМК МГУ', 105063, TIMESTAMP '2017-12-03 19:45:00', 'SHIPPED', 2, 2);
